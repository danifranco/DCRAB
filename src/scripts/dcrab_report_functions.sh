...
#
# Writes the initial values in the reporting html file
#
...
#
# Writes collected data int he html reporting file. This function is made in each loop after collect all the data.
#
dcrab_write_data () {
        ### CPU specific change ###
