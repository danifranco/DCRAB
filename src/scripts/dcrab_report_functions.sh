...
dcrab_generate_html () {
	...
	# MEM plots 
	printf "%s \n" "<div id=\"memChart\" class=\"chart\" style=\"display:none;\">" >> $DCRAB_HTML
	printf "%s \n" "<div class=\"overflowDivs\">" >> $DCRAB_HTML
	if [ "$DCRAB_NNODES" -gt 1 ]; then
	...
	# PROCESSESIO plots
	printf "%s \n" "<div id=\"processesIOChart\" class=\"chart\" style=\"display:none;\">" >> $DCRAB_HTML
	printf "%s \n" "<div class=\"overflowDivs\">" >> $DCRAB_HTML
	i=1
	while [ $i -le $DCRAB_NNODES ]; do
		printf "%s \n" "<div class=\"inline\">" >> $DCRAB_HTML
	...
	# DISK plots
	printf "%s \n" "<div id=\"diskChart\" class=\"chart\" style=\"display:none;\">" >> $DCRAB_HTML
	printf "%s \n" "<div class=\"overflowDivs\">" >> $DCRAB_HTML
	...
	# IB plots
	printf "%s \n" "<div id=\"ibChart\" class=\"chart\" style=\"display:none;\">" >> $DCRAB_HTML
	printf "%s \n" "<div class=\"overflowDivs\">" >> $DCRAB_HTML
	printf "%s \n" "<div class=\"text rcorners inline warningText\" >" >> $DCRAB_HTML
	printf "%s \n" "<center><b>" >> $DCRAB_HTML
	printf "%s \n" "-- WARNING --<br>" >> $DCRAB_HTML
	...
	# NFS plots
	printf "%s \n" "<div id=\"nfsChart\" class=\"chart\" style=\"display:none;\">" >> $DCRAB_HTML
	printf "%s \n" "<div class=\"overflowDivs\">" >> $DCRAB_HTML
	printf "%s \n" "<div class=\"text rcorners inline warningText\" >" >> $DCRAB_HTML
	printf "%s \n" "<center><b>" >> $DCRAB_HTML
	printf "%s \n" "-- WARNING --<br>" >> $DCRAB_HTML
