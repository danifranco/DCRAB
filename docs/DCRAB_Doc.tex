...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=0cm,semithick]
  ...
  \node[state, draw, rectangle, minimum size=3.5em, line width = 0.3mm, fill=orange!30, cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=2.2cm,yshift=0.8cm]         (Z) [below of=B] {};
  ...
  \node[state, fill=green!30,node distance=3cm,xshift=2cm,yshift=-2.5cm]         (U) [below of=D] {$Monitor$};
    \node[state, draw, rectangle,node distance=0cm, minimum size=3.2em, line width = 0.3mm, fill=orange!30,  cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=4.2cm,yshift=4.2cm]         (V) [right of=D] {};
  ...
  \node[state, draw, node distance=0cm, rectangle, minimum size=3.2em, line width = 0.3mm, fill=orange!30,  cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=2cm,yshift=-3cm]         (G) [below of=F] {};
  \node[state, draw, rectangle, minimum size=3.2em, line width = 0.3mm, fill=orange!30,  cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=-6cm,yshift=-4cm]         (H) [above of=G] {};
  \node[state, fill=red!30,yshift=0cm,xshift=-2cm]         (W) [below of=H] {$Exit$};
  ...
  \node[state, draw, rectangle, minimum size=3.2em, line width = 0.3mm, fill=orange!30, cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=4.3cm,yshift=1cm]         (M) [below of=L] {};
  ...
  \path (A) edge              node {Executes} (B)
        ...
        (G) edge              node {} (H)
            edge              node [above]{Yes} (W)
        (H) edge [bend left]  node [right] {No} (D)
            edge [bend right] node {Yes} (W)
        (I) edge              node {} (J)
        (J) edge              node {} (K)
        ...
        (U) edge              node [left] {dcrab\_collect\_data} (E);
...
\draw [->, dashed,rounded corners, thick, black, yshift=-11.8cm, xshift=9.6cm] (-0.5,0.2) -- (0.75,1.2);
...
\node[node distance=0.4cm, xshift=-0.26cm] (t11) [below of=t10] {dcrab\_determine\_main\_process};
...
\node[yshift=-10cm,xshift=1.1cm] (t51)  {MPI process starts};
...
\node[cm={cos(35) ,-sin(35) ,sin(35) ,cos(35) ,(0 cm,0 cm)},yshift=-14.9cm,xshift=12.1cm] (t51)  {dcrab\_check\_alive\_main\_node};
\node[cm={cos(35) ,-sin(35) ,sin(35) ,cos(35) ,(0 cm,0 cm)},node distance=0.4cm] [below of=t51] (t52)  {(90 seconds of check)};

% All the exit messages
\node[xshift=-0.275cm,yshift=-17.6cm,xshift=-0.9cm] (t53) {Exit};
\node[xshift=-0.275cm,yshift=-21.15cm,xshift=4.05cm] (t55) {Exit};
