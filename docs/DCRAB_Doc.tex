...
\node [level 4, below of = c212] (c213) {dcrab\_determine\_main\_process};
...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=0cm,semithick]
  ...
  \node[state, draw, rectangle, minimum size=3.5em, line width = 0.3mm, fill=red!30, cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=3cm,yshift=0cm]         (Z) [below of=B] {};


  \node[state, fill=green!30,node distance=5cm]         (C) [left of=Z] {$Monitor$};
  \node[state, fill=green!30,node distance=3cm,xshift=-2.9cm,yshift=-1cm]         (D) [below of=C] {$Monitor$};
  \node[state, draw, rectangle,node distance=0cm, minimum size=3.2em, line width = 0.3mm, fill=red!30,  cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=3.5cm,yshift=-1.5cm]         (V) [below of=D] {};
  \node[state, fill=green!30,node distance=3cm,xshift=0cm,yshift=0cm]         (U) [right of=V] {$Monitor$};
  \node[state, fill=green!30,node distance=0cm,xshift=1.5cm,yshift=-3cm]         (E) [below of=U] {$Monitor$};
  \node[state, fill=green!30,node distance=4cm,xshift=2.5cm,yshift=2cm]         (F) [below of=E] {$Monitor$};
  \node[state, draw, node distance=0cm, rectangle, minimum size=3.2em, line width = 0.3mm, fill=red!30,  cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=2cm,yshift=-3cm]         (G) [below of=F] {};
  \node[state, draw, rectangle, minimum size=3.2em, line width = 0.3mm, fill=red!30,  cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=-6cm,yshift=-4cm]         (H) [above of=G] {};
  \node[state, fill=green!0,yshift=0cm,xshift=-2cm]         (W) [below of=H] {$Exit$};
  ...
  \node[state, fill=green!30,xshift=-3.3cm,yshift=-0cm]         (K) [below of=J] {$Monitor$};
  \node[state, fill=green!30]         (L) [below of=K] {$Monitor$};
  \node[state, draw, rectangle, minimum size=3.2em, line width = 0.3mm, fill=red!30, cm={cos(45) ,-sin(45) ,sin(45) ,cos(45) ,(0 cm,0 cm)},xshift=4.3cm,yshift=1cm]         (M) [below of=L] {};
	\node[state, node distance=2cm,  fill=red!30]         (N) [below of=M] {$Finalize$};
  ...
  \path (A) edge              node {1} (B)
        ...
        (I) edge              node {} (J)
        (J) edge              node {} (K)
        (K) edge              node {dcrab\_update\_report} (L)
        (L) edge              node {14} (M)
        (M) edge [bend right] node {No} (J)
        (V) edge              node {No} (U)
        (U) edge              node [right]{dcrab\_collect\_data} (E);

\filldraw[rounded corners=15pt, fill=green!30, draw=black, yshift=-10.4cm, xshift=2.4cm] (0,0) rectangle (6,3.4);
\node[yshift=-7.4cm, xshift=5.4cm] (t12)   {dcrab\_node\_monitoring\_functions.sh :};
...
\draw [<-, dashed,rounded corners, thick, black, yshift=-10.3cm, xshift=9.7cm] (0,0) -- (0,1) -- (-1,1);
\draw[->, dashed, yshift=-11.1cm, xshift=5cm] (0,0) .. controls (2,-3) .. (-1.1, -3.6);
...
\node[node distance=0.4cm, yshift=-6.2cm,xshift=1.5cm] (t10) {dcrab\_node\_monitor\_init\_variables};
\node[node distance=0.4cm, xshift=-0.275cm] (t11) [below of=t10] {dcrab\_determine\_main\_process};
\node[node distance=0.4cm, yshift=-3.95cm,xshift=5.0cm] (t40) {Node};
\node[node distance=0.4cm] (t41) [below of=t40] {number};
\node[node distance=0.4cm, yshift=-6cm,xshift=8.5cm] (t42) {dcrab\_node\_monitor\_init\_variables};
\node[node distance=0.4cm, xshift=-0.275cm,xshift=0.5cm] (t43) [below of=t42] {dcrab\_determine\_main\_process};
\node[node distance=0.4cm, yshift=-4cm, xshift=2.5cm] (t11) {!=0};
\node[cm={cos(55) ,sin(55) ,-sin(55) ,cos(55) ,(0 cm,0 cm)},yshift=-1.2cm,xshift=-5cm] (t44)  {dcrab\_wait\_control\_port};
\node[cm={cos(42) ,sin(42) ,-sin(42) ,cos(42) ,(0 cm,0 cm)},yshift=-15.1cm,xshift=1.9cm] (t46)  {dcrab\_collect\_data};
\node[node distance=0.4cm, yshift=-14.8cm,xshift=-2.6cm] (t47) {No};
\node[node distance=0.4cm, yshift=-13.9cm,xshift=-0.5cm] (t48) {which means that};
\node[node distance=0.4cm] (t49) [below of=t48] {the main node is};
\node[node distance=0.4cm] (t50) [below of=t49] {still running the};
\node[node distance=0.4cm] (t51) [below of=t50] {job};
\node[cm={cos(35) ,-sin(35) ,sin(35) ,cos(35) ,(0 cm,0 cm)},yshift=-13.6cm,xshift=12.65cm] (t51)  {dcrab\_check\_alive\_main\_node};
\node[cm={cos(35) ,-sin(35) ,sin(35) ,cos(35) ,(0 cm,0 cm)},yshift=-14.2cm,xshift=12.65cm] (t52)  {(90 seconds of check)};
\node[xshift=-0.275cm,yshift=-11.8cm,xshift=-1.2cm] (t53) {Exit};
\node[xshift=-0.275cm,yshift=-20.3cm,xshift=5.1cm] (t54) {Exit};
\node[xshift=-0.275cm,yshift=-16.8cm,xshift=0.15cm] (t55) {Exit};
\node[xshift=-0.275cm,yshift=-18cm,xshift=10cm] (t56) {Exit3};

\draw [-,xshift=-0.4cm, yshift=-15.3cm] (1,0) arc (-60:60:1cm);
\draw [-,xshift=-1.5cm, yshift=-13.5cm,cm={cos(180) ,sin(180) ,-sin(180) ,cos(180) ,(0 cm,0 cm)}] (0,0) arc (-60:60:1cm);
