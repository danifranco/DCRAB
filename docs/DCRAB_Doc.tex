...
\filldraw[rounded corners=15pt, fill=green!30, draw=black, node distance=0.4cm, yshift=-1.1cm, xshift=9.5cm] (0,0) rectangle (5.7,1.5);
...
\draw [<-, rounded corners, thick, black, yshift=-0.5cm, xshift=9cm] (-0.15,0.15) -- (0.2,0) -- (0.5,0);
...
\end{tikzpicture}
\caption{DCRAB's scheme}
\labe{dcrabCodeScheme}
\end{figure}

In the example \ref{dcrabCodeScheme}
